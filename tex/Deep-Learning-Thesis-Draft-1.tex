...
Let the $M^{max}$ be the total size of the training dataset.  

The cost function is given by the average difference between the value predicted by the network and the target during the
training phase.
