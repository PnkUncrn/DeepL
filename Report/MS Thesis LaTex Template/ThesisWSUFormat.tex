...
\doublespacing{
\begin{align*}
&IoT &&\text{Internet of Things}\\
&IT &&\text{Information Technology}\\
&DI &&\text{Defect Injection}\\
&AM &&\text{Additive Manufacturing}\\
&AC &&\text{Alternating Current}\\
&DC &&\text{Direct Current}\\
&MSE &&\text{Mean Squared Error}\\
&FNN &&\text{Feed-forward Neural Network}\\
&CNC &&\text{Computer Numerical Control}
